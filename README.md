...
## Quick Start
1. Navigate to https://github.com/Bao-143/beode-ios/releases/latest, if you are not **jailbroken**, download the latest **ipa** file. If you wish to use the tweak and have **TrollStore**, download the latest **tipa** file.
